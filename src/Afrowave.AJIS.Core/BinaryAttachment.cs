...
/// <summary>
/// Represents a binary attachment in AJIS (ATP - Attachment Transfer Protocol). Enables seamless embedding of binary
/// files in AJIS documents with compression and validation.
/// </summary>
...
{
   /// <summary>
   /// Enable automatic compression for attachments. Default: true (gzip for small files, brotli for large).
   /// </summary>
   public bool AutoCompress { get; set; } = true;

   /// <summary>
   /// Maximum file size in bytes. 0 = unlimited. Default: 0 (no limit).
   /// </summary>
   public long MaxFileSize { get; set; } = 0;

   /// <summary>
   /// Allowed MIME types (e.g., "application/pdf", "image/*"). null = allow any MIME type.
   /// </summary>
   public string[]? AllowedMimeTypes { get; set; }

   /// <summary>
   /// Enable checksum verification on deserialization. Default: true.
   /// </summary>
   public bool VerifyChecksum { get; set; } = true;

   /// <summary>
   /// Enable encryption for this attachment (future feature). Default: false.
   /// </summary>
    ...
    bool verifyChecksum = true)
{
   ...
   private readonly string[]? _allowedMimeTypes = allowedMimeTypes;
   private readonly bool _verifyChecksum = verifyChecksum;
