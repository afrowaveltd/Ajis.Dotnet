...
/// </summary>
public sealed class AjisFileIndex<T>(string filePath, string keyProperty) : IDisposable where T : notnull
{
   private readonly string _filePath = filePath ?? throw new ArgumentNullException(nameof(filePath));
   private readonly string _keyProperty = keyProperty ?? throw new ArgumentNullException(nameof(keyProperty));
