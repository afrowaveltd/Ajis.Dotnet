...
public sealed class AjisFileReader : IAsyncDisposable, IDisposable
{
   ...
   {
#pragma warning disable CA1513 // Použití pomocné rutiny vyvolání ObjectDisposedException
      if(_disposed)
         throw new ObjectDisposedException(nameof(AjisFileReader));
#pragma warning restore CA1513 // Použití pomocné rutiny vyvolání ObjectDisposedException
   }
}