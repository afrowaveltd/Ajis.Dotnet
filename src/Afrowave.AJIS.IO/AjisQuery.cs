...
/// </summary>
internal class AjisQueryProvider<T>(string filePath, string? indexProperty) : IQueryProvider where T : notnull
{
   private readonly string _filePath = filePath;
   private readonly string? _indexProperty = indexProperty;
