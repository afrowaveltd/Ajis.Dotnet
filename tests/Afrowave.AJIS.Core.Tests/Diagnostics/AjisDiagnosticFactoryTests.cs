...
public sealed class AjisDiagnosticFactoryTests
{
   ...
   {
      CoreDiagnostics.AjisDiagnostic diag = CoreDiagnostics.AjisDiagnosticFactory.Error(
      ...
      IReadOnlyDictionary<string, object?> data = Assert.IsType<IReadOnlyDictionary<string, object?>>(diag.Data, exactMatch: false);
