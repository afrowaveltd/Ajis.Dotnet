...
public sealed class BinaryAttachmentTests
{
   ...
   public void AttachmentValidator_WithValidData_Passes()
   {
      ...
      var validator = new AttachmentValidator(
          ...
          allowedMimeTypes: [.. allowedMimeTypesArray]
      );
   ...
   private static readonly string[] allowedMimeTypes = ["image/*"];
   private static readonly string[] allowedMimeTypesArray = new[] { "application/pdf", "image/*" };
   ...
   public void MultipleAttachments_InCollection_AllHaveUniqueIds()
   {
      ...
      var attachments = new List<BinaryAttachment>
        {
            new() { FileName = "file1.txt", Data = [1, 2, 3] },
            new() { FileName = "file2.txt", Data = [4, 5, 6] },
            new() { FileName = "file3.txt", Data = [7, 8, 9] }
        };
