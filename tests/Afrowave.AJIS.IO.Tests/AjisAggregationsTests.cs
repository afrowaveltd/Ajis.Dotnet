...
public class AjisAggregationsTests : IDisposable
{
      ...
      var products = new List<TestProduct>
        {
            ...
            new()  { Id = 3, Name = "Product3", Price = 30.0m }
        };
      ...
      var products = new List<TestProduct>
        {
            new() { Id = 1, Name = "ProductA", Price = 10.0m },
            new() { Id = 2, Name = "ProductB", Price = 20.0m },
            new() { Id = 3, Name = "ProductA", Price = 15.0m }, // Same name, different price
            new() { Id = 4, Name = "ProductB", Price = 25.0m }  // Same name, different price
        };
      AjisFile.Create(TestFile, products);
   ...
   public void ComplexQuery_WithMultipleAggregations()
   {
      ...
      var products = new List<TestProduct>
        {
            new() { Id = 1, Name = "Product1", Price = 10.0m, Stock = 100 },
            new() { Id = 2, Name = "Product2", Price = 20.0m, Stock = 50 },
            new() { Id = 3, Name = "Product3", Price = 30.0m, Stock = 75 },
            new() { Id = 4, Name = "Product4", Price = 15.0m, Stock = 200 }
        };
      AjisFile.Create(TestFile, products);
   ...
   private static List<TestProduct> CreateTestProducts()
   {
      return
        [
            new() { Id = 1, Name = "Product1", Price = 10.0m, Stock = 10 },
            new() { Id = 2, Name = "Product2", Price = 20.0m, Stock = 20 },
            new() { Id = 3, Name = "Product3", Price = 30.0m, Stock = 30 }
        ];
   }
}
