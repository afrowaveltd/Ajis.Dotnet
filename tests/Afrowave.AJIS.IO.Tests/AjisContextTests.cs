...
public class AjisContextTests : IDisposable
{
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "addtest.ajis");
      var context = new AjisContext();
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "addmultiple.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "findtest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "updatetest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "removetest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "counttest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "anytest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
      ...
      // Assert
      bool exists = await set.AnyAsync(i => i.Name == "Item2");
      Assert.True(exists);

      bool notExists = await set.AnyAsync(i => i.Name == "Item3");
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "predicatetest.ajis");
      var context = new AjisContext();
      var set = context.Set<TestItem>(filePath);
      ...
      // Assert
      int adultCount = await set.CountAsync(i => i.Age >= 18);
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "test.atp");
      var context = new AjisContext();
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "test.json");
      var context = new AjisContext();
   ...
   {
      // Arrange
      string filePath1 = Path.Combine(_testDirectory, "set1.ajis");
      string filePath2 = Path.Combine(_testDirectory, "set2.ajis");
      var context = new AjisContext();
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "keytest.ajis");
      var context = new AjisContext();
   ...
   {
      // Arrange
      string filePath = Path.Combine(_testDirectory, "getsettest.ajis");
      var context = new AjisContext();
