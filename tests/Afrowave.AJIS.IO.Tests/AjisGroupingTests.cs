...
public class AjisGroupingTests : IDisposable
{
      ...
      List<GroupTestProduct> products = new List<GroupTestProduct>
        {
            ...
            new() { Id = 3, Category = "Books", Price = 20 },
            new() { Id = 4, Category = "Books", Price = 30 }
        };
   ...
   public void GroupByMinMax_FindsMinMaxPerGroup()
   {
      ...
      var (Key, Min, Max) = minMax.First(m => m.Key == "Electronics");
      ...
      List<GroupTestProduct> products = new List<GroupTestProduct>
        {
            ...
            new() { Id = 3, Category = "Books", Price = 20, Stock = 50 },
            new() { Id = 4, Category = "Books", Price = 30, Stock = 30 },
            new() { Id = 5, Category = "Clothing", Price = 50, Stock = 20 }
        };
      AjisFile.Create(TestFile, products);
