...
public static class RoundTripStressTest
{
    ...
    private static List<ExtendedUser> GenerateUsers(int count)
    {
        ...
        var users = new List<ExtendedUser>(count);
    ...
    private static bool ValidateStreamingIntegrity(string inputFile, string outputFile)
    {
        ...
        inputStream.Read(inputStart, 0, sampleSize);
        outputStream.Read(outputStart, 0, sampleSize);
        ...
        inputStream.Read(inputEnd, 0, sampleSize);
        outputStream.Read(outputEnd, 0, sampleSize);
